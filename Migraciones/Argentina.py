...
partners['Feudo Asignado'] = partners.apply(asignado,axis=1)
...
# Coloco el Feudo y Reino
targets_heads['Feudo Asignado'] = targets_heads.apply(asignado,axis=1)
targets_heads = targets_heads[targets_heads['Feudo Asignado'] == 'Si'].copy()
